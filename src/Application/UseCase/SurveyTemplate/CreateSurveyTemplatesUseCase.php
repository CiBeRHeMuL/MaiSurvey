...
class CreateSurveyTemplatesUseCase
{
    ...
    public function __construct(
        ...
        private CreateSurveyTemplateUseCase $useCase,
    ) {
        $this->setLogger($logger);
    }

    public function setLogger(LoggerInterface $logger): CreateSurveyTemplatesUseCase
    {
        $this->logger = $logger;
    ...
    /**
     * @param CreateSurveyTemplateDto[] $dtos
     *
